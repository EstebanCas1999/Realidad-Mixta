            ...
            Dictionary<string, Material> typeMaterials = new Dictionary<string, Material>()
        {
            ...
            if (isFirstRun == true)
            {
                ...
                foreach (ElementData element in elements)
                {
                    ...
                    newElement.GetComponentInChildren<ElementCustom>().SetFromElementData(element, typeMaterials);
            ...
            else
            {
                ...
                {
                    existingElementObject.parent.GetComponentInChildren<ElementCustom>().SetFromElementData(elements[i], typeMaterials);
